...
const DailySurveyModal = ({ open, onClose }: DailySurveyModalProps) => {
  ...
  const SurveyBody = ({ showNav }: { showNav: boolean }) => (
    ...
    return (
      <Drawer open={open} onOpenChange={(o) => { if (!o) onClose(); }}>
        <DrawerContent className="h-[85dvh]">
          <DrawerHeader className="sticky top-0 z-10 bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b">
